...
FROM STREAM READ_FILES(
    "/Volumes/main/dbdemos_iot_platform/turbine_raw_landing/historical_turbine_status",
    format => "json",
...
AS SELECT
  *
FROM STREAM READ_FILES(
    "/Volumes/main/dbdemos_iot_platform/turbine_raw_landing/incoming_data",
    format => "parquet",
    inferColumnTypes => true);
...
AS SELECT
  *
FROM STREAM READ_FILES(
    "/Volumes/main/dbdemos_iot_platform/turbine_raw_landing/turbine",
    format => "json",
    inferColumnTypes => true
);