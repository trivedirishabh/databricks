...
def historical_turbine_status():
    return (
        ...
        .load("/Volumes/main/dbdemos_iot_platform/turbine_raw_landing/historical_turbine_status")
    )
...
def sensor_bronze():
    return (
        ...
        .option("cloudFiles.inferColumnTypes", "true")
        .load("/Volumes/main/dbdemos_iot_platform/turbine_raw_landing/incoming_data")
    )
...
def turbine():
    return (
        ...
        .option("cloudFiles.format", "json")
        .option("cloudFiles.inferColumnTypes", "true")
        .load("/Volumes/main/dbdemos_iot_platform/turbine_raw_landing/turbine")
    )
