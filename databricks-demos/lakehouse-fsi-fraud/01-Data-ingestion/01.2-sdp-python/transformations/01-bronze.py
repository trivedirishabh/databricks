...
def bronze_transactions():
    return (
        spark.readStream
            ...
            .load("/Volumes/main/dbdemos_fsi_fraud_detection/fraud_raw_data/transactions")
    )
...
def banking_customers():
    return (
        spark.readStream
            ...
            .load("/Volumes/main/dbdemos_fsi_fraud_detection/fraud_raw_data/customers")
    )
...
def country_coordinates():
    return (
        spark.readStream
            .format("cloudFiles")
            .option("cloudFiles.format", "csv")
            .load("/Volumes/main/dbdemos_fsi_fraud_detection/fraud_raw_data/country_code")
    )
...
def fraud_reports():
    return (
        spark.readStream
            .format("cloudFiles")
            .option("cloudFiles.format", "csv")
            .load("/Volumes/main/dbdemos_fsi_fraud_detection/fraud_raw_data/fraud_report")
    )
