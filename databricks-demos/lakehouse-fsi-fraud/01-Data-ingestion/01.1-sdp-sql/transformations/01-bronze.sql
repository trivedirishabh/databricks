...
FROM STREAM read_files(
  '/Volumes/main/dbdemos_fsi_fraud_detection/fraud_raw_data/transactions',
  format => 'json',
...
SELECT * 
FROM STREAM read_files(
  '/Volumes/main/dbdemos_fsi_fraud_detection/fraud_raw_data/customers',
  format => 'csv',
  multiLine => true,
  inferColumnTypes => true
);
...
SELECT * 
FROM STREAM read_files(
  '/Volumes/main/dbdemos_fsi_fraud_detection/fraud_raw_data/country_code',
  format => 'csv'
);
...
SELECT *
FROM STREAM read_files(
  '/Volumes/main/dbdemos_fsi_fraud_detection/fraud_raw_data/fraud_report',
  format => 'csv'
);
