...
FROM STREAM read_files(
  '/Volumes/main/dbdemos_fsi_credit_decisioning/credit_raw_data/credit_bureau',
  format => 'json',
...
SELECT *
FROM STREAM read_files(
  '/Volumes/main/dbdemos_fsi_credit_decisioning/credit_raw_data/internalbanking/customer',
  format => 'csv',
  header => true,
  inferSchema => true,
  inferColumnTypes => true,
...
SELECT *
FROM STREAM read_files(
  '/Volumes/main/dbdemos_fsi_credit_decisioning/credit_raw_data/internalbanking/relationship',
  format => 'csv',
  header => true,
  inferSchema => true,
  inferColumnTypes => true
...
SELECT *
FROM STREAM read_files(
  '/Volumes/main/dbdemos_fsi_credit_decisioning/credit_raw_data/internalbanking/account',
  format => 'csv',
  header => true,
  inferSchema => true,
  inferColumnTypes => true
...
SELECT *
FROM STREAM read_files(
  '/Volumes/main/dbdemos_fsi_credit_decisioning/credit_raw_data/fund_trans',
  format => 'json',
  inferColumnTypes => true
);
...
SELECT *
FROM STREAM read_files(
  '/Volumes/main/dbdemos_fsi_credit_decisioning/credit_raw_data/telco',
  format => 'json',
  inferColumnTypes => true
);