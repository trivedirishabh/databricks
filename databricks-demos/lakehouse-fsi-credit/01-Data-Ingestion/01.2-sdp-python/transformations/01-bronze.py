...
def credit_bureau_bronze():
    return (
        spark.readStream
             ...
             .load("/Volumes/main/dbdemos_fsi_credit_decisioning/credit_raw_data/credit_bureau")
    )
...
def customer_bronze():
    return (
        spark.readStream
             ...
             .load("/Volumes/main/dbdemos_fsi_credit_decisioning/credit_raw_data/internalbanking/customer")
    )
...
def relationship_bronze():
    return (
        spark.readStream
             ...
             .option("inferSchema", "true")
             .option("cloudFiles.inferColumnTypes", "true")
             .load("/Volumes/main/dbdemos_fsi_credit_decisioning/credit_raw_data/internalbanking/relationship")
    )
...
def account_bronze():
    return (
        spark.readStream
             ...
             .option("inferSchema", "true")
             .option("cloudFiles.inferColumnTypes", "true")
             .load("/Volumes/main/dbdemos_fsi_credit_decisioning/credit_raw_data/internalbanking/account")
    )
...
def fund_trans_bronze():
    return (
        spark.readStream
             ...
             .option("cloudFiles.format", "json")
             .option("cloudFiles.inferColumnTypes", "true")
             .load("/Volumes/main/dbdemos_fsi_credit_decisioning/credit_raw_data/fund_trans")
    )
...
def telco_bronze():
    return (
        spark.readStream
             ...
             .option("cloudFiles.format", "json")
             .option("cloudFiles.inferColumnTypes", "true")
             .load("/Volumes/main/dbdemos_fsi_credit_decisioning/credit_raw_data/telco")
    )